  ...
  return (
    <form onSubmit={onSubmit}>
      <div className="flex flex-col gap-5">
        {callbackUrl && !send && ( 
          <div className="bg-destructive/10 text-destructive text-sm rounded p-4 border-[1.25px] border-destructive/20">
        ...
        {send && (
          <div className="bg-green-500/10 text-green-500 text-sm rounded p-4 border-[1.25px] border-green-500/20">
